...
public class jFrmRegistrase extends javax.swing.JFrame {

    /**
     * Creates new form jFrmAgregarUsuario
     */
    public jFrmRegistrase() {
        initComponents();
    }
    ...
    private void jbtnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnGuardarActionPerformed
        ...
        this.dispose();
        // Se estblece el usuario logueado
        ControlUsuarios.establecerUsuario(usuario);
        // Se llama al form principal
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jFrmRegistrase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jFrmRegistrase().setVisible(true);
            }
        });
    }
