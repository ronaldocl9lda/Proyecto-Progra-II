...
public class jFrmAgregarUsuario extends javax.swing.JFrame {

    /**
     * Creates new form jFrmAgregarUsuario
     */
    public jFrmAgregarUsuario() {
        initComponents();
    }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(jpwdfClave, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // Se cargan los diferentes tipos de usuario en el combo box de tipo de usuario
        for (TipoUsuario tipoUsuario:TipoUsuario.values()){
            jcboTipoUsuario.addItem(tipoUsuario);
        }
        
        // Se cargan los diferentes paises al combo box de paises
        for (Pais pais:PersistenciaPais.getArrayPaisesActivos()){
            jcboPais.addItem(pais);
        }
        
        // llama al metodo que limpia los campos del form
        limpiarCampos();
    ...
    private void jbtnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnGuardarActionPerformed
        ...
        // Se crea una nueva variable de usuario
        Usuario usuario = new Usuario (jtxtCorreo.getText(), jtxtUsuario.getText(), 
            jpwdfClave.getText(), jtxtNombre.getText(), (Pais) jcboPais.getSelectedItem(), 
            (TipoUsuario) jcboTipoUsuario.getSelectedItem());
        //Se manda a guardar el usuario en la persistencia
        PersistenciaUsuario.agregarUsuario(usuario);
        // Se envia mensaje de confirmacion
        JOptionPane.showMessageDialog(null, "Usuario Agregado", "", JOptionPane.INFORMATION_MESSAGE);
        // Se limpian los campos del form
        limpiarCampos();
        // se asigna el foco al campo de texto usuario
        jtxtUsuario.requestFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jFrmAgregarUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jFrmAgregarUsuario().setVisible(true);
            }
        });
    }
    
    public void limpiarCampos(){
        // Limpia los campos de texto del form y reinicia la selecciones de los combo box
        jtxtCorreo.setText("");
        jtxtUsuario.setText("");
        jtxtNombre.setText("");
        jpwdfClave.setText("");
